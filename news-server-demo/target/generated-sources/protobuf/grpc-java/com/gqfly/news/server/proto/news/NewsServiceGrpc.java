...
public final class NewsServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.gqfly.news.server.proto.news.NewsRequest,
      com.gqfly.news.server.proto.news.NewsResponse> getListMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "list",
      requestType = com.gqfly.news.server.proto.news.NewsRequest.class,
      responseType = com.gqfly.news.server.proto.news.NewsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.gqfly.news.server.proto.news.NewsRequest,
      com.gqfly.news.server.proto.news.NewsResponse> getListMethod() {
    io.grpc.MethodDescriptor<com.gqfly.news.server.proto.news.NewsRequest, com.gqfly.news.server.proto.news.NewsResponse> getListMethod;
      ...
      synchronized (NewsServiceGrpc.class) {
        if ((getListMethod = NewsServiceGrpc.getListMethod) == null) {
          NewsServiceGrpc.getListMethod = getListMethod =
              io.grpc.MethodDescriptor.<com.gqfly.news.server.proto.news.NewsRequest, com.gqfly.news.server.proto.news.NewsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "list"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.gqfly.news.server.proto.news.NewsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.gqfly.news.server.proto.news.NewsResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.gqfly.news.server.proto.news.StringRequest,
      com.gqfly.news.server.proto.news.StringResponse> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hello",
      requestType = com.gqfly.news.server.proto.news.StringRequest.class,
      responseType = com.gqfly.news.server.proto.news.StringResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.gqfly.news.server.proto.news.StringRequest,
      com.gqfly.news.server.proto.news.StringResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<com.gqfly.news.server.proto.news.StringRequest, com.gqfly.news.server.proto.news.StringResponse> getHelloMethod;
    if ((getHelloMethod = NewsServiceGrpc.getHelloMethod) == null) {
      synchronized (NewsServiceGrpc.class) {
        if ((getHelloMethod = NewsServiceGrpc.getHelloMethod) == null) {
          NewsServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<com.gqfly.news.server.proto.news.StringRequest, com.gqfly.news.server.proto.news.StringResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.gqfly.news.server.proto.news.StringRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.gqfly.news.server.proto.news.StringResponse.getDefaultInstance()))
  ...
  public static abstract class NewsServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void list(com.gqfly.news.server.proto.news.NewsRequest request,
        io.grpc.stub.StreamObserver<com.gqfly.news.server.proto.news.NewsResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getListMethod(), responseObserver);
    }

    /**
     */
    public void hello(com.gqfly.news.server.proto.news.StringRequest request,
        io.grpc.stub.StreamObserver<com.gqfly.news.server.proto.news.StringResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.gqfly.news.server.proto.news.NewsRequest,
                com.gqfly.news.server.proto.news.NewsResponse>(
                  this, METHODID_LIST)))
          .addMethod(
            getHelloMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.gqfly.news.server.proto.news.StringRequest,
                com.gqfly.news.server.proto.news.StringResponse>(
                  this, METHODID_HELLO)))
          .build();
    }
  }
  ...
  public static final class NewsServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<NewsServiceBlockingStub> {
    ...
    /**
     */
    public com.gqfly.news.server.proto.news.NewsResponse list(com.gqfly.news.server.proto.news.NewsRequest request) {
    ...
    /**
     */
    public com.gqfly.news.server.proto.news.StringResponse hello(com.gqfly.news.server.proto.news.StringRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class NewsServiceFutureStub extends io.grpc.stub.AbstractFutureStub<NewsServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.gqfly.news.server.proto.news.NewsResponse> list(
        com.gqfly.news.server.proto.news.NewsRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.gqfly.news.server.proto.news.StringResponse> hello(
        com.gqfly.news.server.proto.news.StringRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LIST:
          serviceImpl.list((com.gqfly.news.server.proto.news.NewsRequest) request,
              (io.grpc.stub.StreamObserver<com.gqfly.news.server.proto.news.NewsResponse>) responseObserver);
          break;
        case METHODID_HELLO:
          serviceImpl.hello((com.gqfly.news.server.proto.news.StringRequest) request,
              (io.grpc.stub.StreamObserver<com.gqfly.news.server.proto.news.StringResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class NewsServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.gqfly.news.server.proto.news.NewsProto.getDescriptor();
    }
