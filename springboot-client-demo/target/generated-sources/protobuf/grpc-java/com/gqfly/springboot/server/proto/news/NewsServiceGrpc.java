...
public final class NewsServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.gqfly.springboot.server.proto.news.StringRequest,
      com.gqfly.springboot.server.proto.news.StringResponse> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hello",
      requestType = com.gqfly.springboot.server.proto.news.StringRequest.class,
      responseType = com.gqfly.springboot.server.proto.news.StringResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.gqfly.springboot.server.proto.news.StringRequest,
      com.gqfly.springboot.server.proto.news.StringResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<com.gqfly.springboot.server.proto.news.StringRequest, com.gqfly.springboot.server.proto.news.StringResponse> getHelloMethod;
      ...
      synchronized (NewsServiceGrpc.class) {
        if ((getHelloMethod = NewsServiceGrpc.getHelloMethod) == null) {
          NewsServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<com.gqfly.springboot.server.proto.news.StringRequest, com.gqfly.springboot.server.proto.news.StringResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.gqfly.springboot.server.proto.news.StringRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.gqfly.springboot.server.proto.news.StringResponse.getDefaultInstance()))
  ...
  public static abstract class NewsServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void hello(com.gqfly.springboot.server.proto.news.StringRequest request,
        io.grpc.stub.StreamObserver<com.gqfly.springboot.server.proto.news.StringResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.gqfly.springboot.server.proto.news.StringRequest,
                com.gqfly.springboot.server.proto.news.StringResponse>(
                  this, METHODID_HELLO)))
          .build();
    }
  }
  ...
  public static final class NewsServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<NewsServiceBlockingStub> {
    ...
    /**
     */
    public com.gqfly.springboot.server.proto.news.StringResponse hello(com.gqfly.springboot.server.proto.news.StringRequest request) {
  ...
  public static final class NewsServiceFutureStub extends io.grpc.stub.AbstractFutureStub<NewsServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.gqfly.springboot.server.proto.news.StringResponse> hello(
        com.gqfly.springboot.server.proto.news.StringRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((com.gqfly.springboot.server.proto.news.StringRequest) request,
              (io.grpc.stub.StreamObserver<com.gqfly.springboot.server.proto.news.StringResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class NewsServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.gqfly.springboot.server.proto.news.NewsProto.getDescriptor();
    }
